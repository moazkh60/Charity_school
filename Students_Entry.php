<?php
    ...
    if(isset($_POST['btn_sub'])){
        ...
        $dob     = $_POST['dob'];
        $mail    = $_POST['emailtxt'];
		$stu_expense = $_POST['stu_expense'];
		
        $sql_ins=mysql_query("INSERT INTO stu_tbl VALUES('$roll_no', NULL,'$f_name','$l_name','$gender','$dob','$addr','$phone','$mail','$stu_expense')");
        if($sql_ins==true) {
            $msg = ucfirst($f_name) ;
            echo "<div>"
    ...
    <div class="col-md-10 col-md-offset-1 form-style">
            <form role="form" data-toggle="validator" method="post" class="form-horizontal">
                <div class="row">
                    ...
                    <div class="form-group">
                        <label for="phonetxt" class="control-label col-sm-3">Expense:</label>
                        <div class="col-sm-8">
                            <input type="number"data-minlength="1" class="form-control only-number" data-error="Enter Expense if none type 0  " id="stu_expense" name="stu_expense" value="<?php echo $rs_upd['student_expense'];?>">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <form role="form" data-toggle="validator" method="post" class="form-horizontal">
            <div class="row">
                ...
                <div class="form-group">
                    <label for="phonetxt" class="control-label col-sm-3">Expense</label>
                    <div class="col-sm-8">
                        <input type="number" data-minlength="1" class="form-control only-number" data-error="Enter Expense if none write 0" id="stu_expense" name="stu_expense"  placeholder="Student Expense" required>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="form-group">
